    ...
    <main>
      ...
      <section className="hero">
        <div className="container">
          ...
          <p className="fade-in">
            Collect & Earn was founded with a simple mission: make recycling
            rewarding for everyone. We connect collectors with recyclers,
            creating a sustainable ecosystem where environmental responsibility
        ...
        <div className="container">
          <div className="mission-grid">
            <div className="mission-content fade-in">
              ...
              <p>
                We're on a mission to revolutionize how communities handle
                recyclable materials. By creating direct connections between
                collectors and certified recycling facilities, we're building a
                more efficient and rewarding recycling ecosystem.
              </p>
              <p>
                Our platform empowers individuals to earn from their recycling
                efforts while contributing to a cleaner planet. Every bottle
                collected, every can recycled, brings us closer to a sustainable
                future.
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div className="values-grid">
            ...
            <div className="value-card fade-in">
              ...
              <h3>Fair Rewards</h3>
              <p>
                We ensure collectors and recyclers receive fair compensation for
            ...
            <div className="value-card fade-in">
              ...
              <h3>Transparency</h3>
              <p>
                Track every item from collection to processing with complete
                visibility into the recycling journey.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="cta">
        <div className="container">
          ...
          <p className="fade-in">
            Whether you're a collector looking to earn, a recycler seeking
            reliable supply, or a business wanting to improve your
            sustainability practices, Collect & Earn has a place for you in our
            growing community.
          </p>
