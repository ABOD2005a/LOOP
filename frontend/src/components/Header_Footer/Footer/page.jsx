        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-col">
              ...
              <p>Egypt's premier recycling platform. Making sustainability profitable for everyone.</p>
            ...
            <div className="footer-col">
              <h4>Contact</h4>
              <ul>
                <li><i className="fas fa-phone"></i> 01234567890</li>
                <li><i className="fas fa-envelope"></i> info@karakib.com</li>
